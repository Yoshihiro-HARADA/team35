...
<body>
    ...
    <div class="content_wrapper">
        ...
        <div class="main_content">
            <div class="my-icon">
                <img src="../admin.pre/img/kanna.png" alt="">
            </div>
                ...
                <div class="sub_content">
                    <div class="sub_sub_content">
                        ...
                        <div class="like_hobby">
                            ...
                            <div class="like">
                                <img src="../admin.pre/img/icon-heart-twitterblue.svg" alt="">
                            </div>
                            <div class="like-count">101462475</div> 
                        </div>
                    </div>
                    <div class="hobby_picture">
                        <img src="../admin.pre/img/hobby_picture.jfif" alt="">
                    </div>
                </div>
        ...
        <div class="main_content">
            ...
            <div class="hobby_content">
                ...
                <div class="sub_content">
                    ...
                    <div class="hobby_picture">
                        <img src="../admin.pre/img/hobby_picture2.jfif" alt="">
                    </div>
                </div>
                <div class="edit_button">
                    <form action="post" class="my_edit">
        ...
        <div class="main_content">
            ...
            <div class="hobby_content">
                ...
                <div class="sub_content">
                    ...
                    <div class="hobby_picture">
                        <img src="../admin.pre/img/hobby_picture3.jfif" alt="">
                    </div>
                </div>
                <div class="edit_button">
                    <form action="post" class="my_edit">
